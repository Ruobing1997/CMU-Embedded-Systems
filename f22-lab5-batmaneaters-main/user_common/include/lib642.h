...
/**
 * @brief      Get status of button press
 *
 * @return     flag indicate whether a button is pressed
 */
uint8_t button_press();

/**
 * @brief      Get random initialized value
 *
 * @return     random initialized value
 */
...
/**
 * @brief   Set pix value using r, g, b value
 * @param r red value for setting pixel
 * @param g green value for setting pixel
 * @param b blue value for setting pixel
 * @return  None
 */
void pix_set(int r, int g, int b);

/**
 * @brief   start flashy with new freq
 * @param freq new freq for setting timer for flashy led
 * @return  None
 */
void start_flash(int freq);

/**
 * @brief   stop flashy led
 * @return  None
 */
void stop_flash();
